...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     ...
     <script src="../../Script/PageScript/dateforecast.js?ie" type="text/javascript"></script> 
</asp:Content>
...
<div style="height:50%;padding-top:10px;">
    <div style="width:49.5%;height:100%;float:left;border:1px solid #ccc;"><img style="width:100%;height:100%;" id="img1" /></div>
    <div style="width:49.5%;height:100%;float:right;border:1px solid #ccc;"><img style="width:100%;height:100%;" id="img2" /></div>
</div>
            <div style="height:50%;padding-top:10px;">
                <div style="width:49.5%;height:100%; float:left;border:1px solid #ccc;"><img style="width:100%;height:100%;" id="img3" /></div>
                <div style="width:49.5%;height:100%; float:right;border:1px solid #ccc;"><img style="width:100%;height:100%;" id="img4" /></div>
            </div>

             <div style="height:50%;padding-top:10px;">
                <div style="width:49.5%;height:100%; float:left;border:1px solid #ccc;"><img style="width:100%;height:100%;" id="img5" /></div>
                <div style="width:49.5%;height:100%; float:right;border:1px solid #ccc;"><img style="width:100%;height:100%;" id="img6" /></div>
            </div>

             <div style="height:50%;padding-top:10px;">
                <div style="width:49.5%;height:100%; float:left;border:1px solid #ccc;"><img style="width:100%;height:100%;" id="img7" /></div>
                <div style="width:49.5%;height:100%; float:right;border:1px solid #ccc;"><img style="width:100%;height:100%;" id="img8" /></div>
            </div>
