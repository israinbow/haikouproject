        ...
        <div id="TimeChoice">
            <div class="tc_forestTime">
                <div class="tc_forestTime" data-toggle="buttons">
                    ...
                    <ul>
                        <li>
                            <button type="button" class="btn btn-primary btn-sm active" data-foresthour="6">06:00</button></li>
                        <li>
                            <button type="button" class="btn btn-primary btn-sm" data-foresthour="11">11:00</button></li>
                        <li>
                            <button type="button" class="btn btn-primary btn-sm" data-foresthour="20">16:00</button></li>
                    </ul>
