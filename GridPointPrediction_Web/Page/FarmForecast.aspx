<%@ Page Language="C#"  MasterPageFile="~/Page/MainForm.Master"  AutoEventWireup="true" CodeBehind="FarmForecast.aspx.cs" Inherits="GridPointPrediction_Web.Page.FarmForecast" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="../Script/bootstrap-3.3.5/css/bootstrap.css" />
    <link href="../Style/PageStyle/FarmForecast.css" rel="stylesheet" type="text/css" />
    ...
    <script src="../Script/PageScript/FarmForecast.js" type="text/javascript"></script>
            ...
            <div class="row editPage" style="width:93%;margin:0">
                <div class="col-lg-9 col-md-9 col-sm-9" style="margin:10px 0px 0px 380px;padding:0;">
                   ...
                   <div class="weather_situation">
                        ...
                        <textarea id="weather_situation" style="overflow: auto; font-size: 14px; line-height: 24px; height: 126px; width: 98%; border-color:#aaa; margin: 5px 0px 5px 12px;">
                        </textarea>
                    </div>
                    <%--海口市天气趋势预测--%>	
                    ...
                    <%--农事建议--%>
                    <div class="farmSuggest">
                        <div style="width: 100%; height: 40px; border-bottom: 1px solid #ddd;background: #2eb1e8;border-top-left-radius: 7px;border-top-right-radius: 7px;">
                            <label style="height: 40px; color: #FFFFFF; margin-left: 15px; line-height: 38px; display: inline-block;font-family:微软雅黑;font-size:15px;font-weight:bold;">农事建议</label>
                         </div>
                        <div style="width:100%;height:256px;display:inline-block;padding:10px;position:relative">
                            <div style="width: 33%; height: 100%; display: inline-block;">
                                <label style="height: 30px; color: #FFFFFF; padding-left: 15px; width: 100%; line-height: 28px; display: inline-block; font-family: 微软雅黑; font-size: 15px; font-weight: bold; background: #2eb1e8; border-top-left-radius: 7px; border-top-right-radius: 7px; margin-bottom: 0">（一）荔枝</label>
                                <textarea id="lizhiVal" style="overflow: auto; font-size: 14px; line-height: 24px; height: 232px; width: 99.5%; border-color: #aaa; display: inline-block; margin-left: 1px;">
                                </textarea>
                            </div>
                           <div style="width: 33%; height: 100%; display: inline-block;">
                                <label style="height: 30px; color: #FFFFFF; padding-left: 15px; width: 100%; line-height: 28px; display: inline-block; font-family: 微软雅黑; font-size: 15px; font-weight: bold; background: #2eb1e8; border-top-left-radius: 7px; border-top-right-radius: 7px; margin-bottom: 0">（二）瓜菜</label>
                                <textarea id="vegetablesVal" style="overflow: auto; font-size: 14px; line-height: 24px; height: 232px; width: 99.5%; border-color: #aaa; display: inline-block; margin-left: 1px;">
                                </textarea>
                            </div>
                            <div style="width: 33%; height: 100%; display: inline-block;">
                                <label style="height: 30px; color: #FFFFFF; padding-left: 15px; width: 100%; line-height: 28px; display: inline-block; font-family: 微软雅黑; font-size: 15px; font-weight: bold; background: #2eb1e8; border-top-left-radius: 7px; border-top-right-radius: 7px; margin-bottom: 0">（三）水稻</label>
                                <textarea id="shuidaoVal" style="overflow: auto; font-size: 14px; line-height: 24px; height: 232px; width: 99.5%; border-color: #aaa; display: inline-block; margin-left: 1px;">
                                </textarea>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row previewPage" style="display:none;margin: 0px;">
                <div class="col-lg-9 col-md-9 col-sm-9" style="margin:10px 0px 0px 380px;padding:0;">
                    ...
                    <div class="previewContainer">
                        <h1 style="color:red;font-weight:bold;margin-bottom:30px;">海口市农业气象专报</h1>
                        <span style="display:block;"><span class="releaseYear"></span>年第<span class="issueId"></span>期</span>
                        <div class="copyright"><span>市气象局、市农业局，省农业科学院蔬菜研究所，果树研究所</span></div>
                        <h3 style="margin:20px 0px 40px 0px;font-weight:bold">前期天气概况和未来一周天气预报</h3>
                        <div class="cont1">
                        ...
                        <div class="cont2">
                            ...
                            <p></p>
                            <p></p>
                            <table class="haikouWeather_info">
                            <thead>
                                <tr>
                                    <th>时&nbsp;&nbsp;间</th>
                                    <th>天空状况</th>
