<%@ Page Language="C#"   MasterPageFile="~/Page/MainForm.Master" AutoEventWireup="true" CodeBehind="tenDayForecast.aspx.cs" Inherits="GridPointPrediction_Web.Page.tenDayForecast" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="../Script/bootstrap-3.3.5/css/bootstrap.css" />
    <link href="../Style/PageStyle/tenDayForecast.css" rel="stylesheet" type="text/css" />
    ...
    <script src="../Script/PageScript/tenDayForecast.js" type="text/javascript"></script>
        ...
        <div class="container-fluid box" style="padding:0;">
                    ...
                    <div id="secondhead">
                        <div id="SelectPan" style="display:inline-block">
                            ...
                            <div id="ForecastZone" style="display:inline-block">
                                <ul>
                                    <li>
                                        <button type="button" class="btn btn-primary active" name="middleMonth_forecast" onclick="changeForecast('middleMonth_forecast')">中旬</button></li>
                                    <li>
                                        <button type="button" class="btn btn-primary" name="endMonth_forecast" onclick="changeForecast('endMonth_forecast')">下旬</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="contain">
                        <div class="middleMonth_forecast">
                            <div class="middleMonth_detail">
                                ...
                                <textarea id="middleMonth_detail" style="overflow: auto; font-size: 14px; line-height: 24px; height: 126px; width: 98%; border-color: #058dde; margin: 5px 0px 5px 12px;">
                                </textarea>
                            </div>
                        </div>
                        <div class="endMonth_forecast" style="display:none;">
                            <div class="endMonth_detail">
                                <div style="width: 100%; height: 40px; border-bottom: 1px solid #ddd; background: #2eb1e8; border-top-left-radius: 7px; border-top-right-radius: 7px;">
                                ...
                                <textarea id="endMonth_detail" style="overflow: auto; font-size: 14px; line-height: 24px; height: 126px; width: 98%; border-color: #058dde; margin: 5px 0px 5px 12px;">
                                </textarea>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row previewPage" style="display:none;margin: 0px;">
                <div class="col-lg-9 col-md-9 col-sm-9" style="margin: 10px 0px 0px 345px; padding: 0;">
                    ...
                    <%--中旬专报预览页面--%>
                    <div class="previewContainer middle_preview">
                    ...
                    <%--下旬专报预览页面--%>
                    <div class="previewContainer end_preview">
                        <h1 style="color: red; font-weight: bold; margin-bottom: 50px; font-size: 40px;">海口市天气预报</h1>
                        <div class="copyright" style="position:relative;width:100%;height:30px;">
                            <span style="position: absolute; left: 20px;">海口市气象局</span><span style="position: absolute; right: 10px;">电话：65821333</span>
                            <div style="position: absolute;width:100%;top:30px;"></div>
