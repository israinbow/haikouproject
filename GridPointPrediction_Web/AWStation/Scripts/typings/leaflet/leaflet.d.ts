...
declare namespace L {
    ...
    export function imageOverlay(imageUrl: string, bounds: LatLngBoundsExpression | number[][], options?: ImageOverlayOptions): ImageOverlay;
    ...
    export interface Map extends Evented {
        ...
        latLngToLayerPoint(latlng: LatLngExpression | number[]): Point;
        wrapLatLng(latlng: LatLngExpression): LatLng;
        distance(latlng1: LatLngExpression, latlng2: LatLngExpression): number;
        ...
        latLngToContainerPoint(latlng: LatLngExpression | number[]): Point;
