...
interface SliderStatics {
    new (selector: string | HTMLElement, opts: SliderOptions): Slider;
	prototype: Slider;
}
...
interface Slider extends JQuery {
     ...
     */
    setValue(newValue: number | [number, number], triggerSlideEvent?: boolean, triggerChangeEvent?: boolean): void;
    /**
