    ...
    var default_1 = (function () {
        ...
        default_1.prototype.play = function () {
            ...
            var autoPlay = function () {
                ...
                _this.onMove(_this.currentIndex, _this.timeList[_this.currentIndex], function () {
                    _this.playInterval = setTimeout(function () { if (_this.isPlaying)
                        autoPlay(); }, 600);
                });
            };
            autoPlay();
        ...
        default_1.prototype.moveStep = function (isFront) {
            this.stop();
            if (isFront) {
        ...
        default_1.prototype.onMove = function (index, datetime, callback) { };
