...
Tick.prototype = {
	...
	addLabel: function () {
		...
		// Set the ddtime label format. If a higher rank is set for this position, use that. If not,
...
Axis.prototype = {
	...
	defaultOptions: {
		...
		type: 'linear' // linear, logarithmic or ddtime
	},
	...
	defaultLabelFormatter: function () {
		...
		} else if (dateTimeLabelFormat) { // ddtime axis
 ...
 * with the time positions. Used in ddtime axes as well as for grouping
 * data on a ddtime axis.
 *
...
Tooltip.prototype = {
	...
	tooltipFooterHeaderFormatter: function (point, isFooter) {
		var footOrHead = isFooter ? 'footer' : 'header',
			...
			xAxis = series.xAxis,
			isDateTime = xAxis && xAxis.options.type === 'ddtime' && isNumber(point.key),
