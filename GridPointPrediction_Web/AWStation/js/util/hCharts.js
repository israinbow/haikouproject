define(["require", "exports", "library/Highcharts-4.1.8/js/highcharts", "library/Highcharts-4.1.8/js/modules/no-data-to-display"], function (require, exports) {
    "use strict";
    ...
    function hCharts(attr, style) {
        var addTheme = function (src, _style) {
            for (var a in _style) {
                if (src[a] == undefined)
                    src[a] = _style[a];
                else {
